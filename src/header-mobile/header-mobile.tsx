    ...
    return( <>
        <div className="header__mobile">
            ...
            <div className="header__mobile__leftpanel">
                ...
                <div className="alignitemscenter" onClick={()=>(searchClicked == false? setSearchClicked(true) : setSearchClicked(false))}>{searchClicked ? (<img className="searchpic" src={closepic} alt="" />) : (<img className="searchpic" src={lupa} alt="" />)}</div>
                <Link to={"/cartmobile"}>
